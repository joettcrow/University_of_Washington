...
public class SCGDriver
{
    ...
    /**
     * Driver for the SmallConsulting Group that creates consultants and timecards
     */
    public SCGDriver()
    {
    ...
    /**
     * Getter for list of client accounts
     * @return list of clientAccounts
     */
    ...
    /**
     * Does something to personal name to make work easier
     */
    ...
    /**
     * Class for doing something to ClientAccounts that makes work easier
     */
    ...
    /**
     * Class for doing something to address that makes the work easier
     */
