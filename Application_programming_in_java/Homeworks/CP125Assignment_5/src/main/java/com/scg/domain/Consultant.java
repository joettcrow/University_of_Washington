...
public class Consultant implements Comparable<Consultant>, Serializable {
    ...
    private static class Proxy implements Serializable {
        private static final long serialVersionUID = 648146019651554512L;
        private final PersonalName nameCopy;

        public Proxy(Consultant obj) {
            nameCopy = obj.getName();
        }

        public Object readResolve() {
            Consultant result =
                    new Consultant(nameCopy);
    ...
    private Object writeReplace() throws ObjectStreamException {
        LOGGER.info(this.getName().toString());
