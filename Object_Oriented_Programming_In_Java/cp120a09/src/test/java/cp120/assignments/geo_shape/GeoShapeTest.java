...
public class GeoShapeTest{
    ...
    @Test
    public void shapeSameEqualsTest(){
        assert (shape.equals(shape,0.00));
    }

    @Test
    public void shapeNullNotEqualsTest(){
        assert (!shape.equals(null,0.00));
    }

    @Test
    public void objectSameTest(){
        assert (shape.equalsObject(shape,shape));
    }

    @Test
    public void objectNullTest(){
        assert (!shape.equalsObject(null,shape));
    }

//    This is not a thing we can test.  It's just not getting into that code path.
//    @Test
...
//        assert (rect1.equalsObject(rect1,rect2));
//    }
}